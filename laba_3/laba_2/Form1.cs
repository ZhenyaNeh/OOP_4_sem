...
namespace laba_2
{
    public partial class Form1 : Form
    {
        ...
        void BoxState(string lastAction)
        {
            richTextBox2.Text = $"Last action: {lastAction} \nPC count in lab: {PC_list.Count} \nTime:  {DateTime.Now}";
        }
        ...
        public void VerifyComboBox(ComboBox combo)
        {
            if (combo.Text != "")
            {
                combo.BackColor = Color.White;
        ...
        private void AllVerifyInstuction()
        {
            VerifyComboBox(comboBox1);
            VerifyComboBox(comboBox2);
            VerifyComboBox(comboBox3);
        ...
        private void button3_Click(object sender, EventArgs e)
        {
                ...
                maskedTextBox1.BackColor == Color.White)
            {
                ...
                var isValid = Validator.TryValidateObject(pc.CPU, new ValidationContext(pc.CPU), validationResults, true);
                ...
                if (isValid)
                {
                    ...
                    {
                        listPCInLaboratory += $"{i + 1}-st PC " + Calculating.Price(PC_list[i]).ToString() + "$\n";
                    }
                    ...
                    toolStripStatusLabel1.Text = $"Count PC in Lab:{PC_list.Count} Last action: Verify Time: {DateTime.Now}";
                }
                else
                {
                    ...
                    {
                        richTextBox1.Text += validationResult.ErrorMessage;
                    }
                }
            }
            else
        ...
        private void button1_Click(object sender, EventArgs e)
        {
                ...
                maskedTextBox1.BackColor == Color.White)
            {
                PC pc = CreateObject();
                var validationResults = new System.Collections.Generic.List<ValidationResult>();
                var isValid = Validator.TryValidateObject(pc.GPU, new ValidationContext(pc.GPU), validationResults, true);
                ...
                if (isValid)
                {
                    ...
                    toolStripStatusLabel1.Text = $"Count PC in Lab:{PC_list.Count} Last action: Save Time: {DateTime.Now}";
        ...
        {
            PC_list = WorkWithFille.DeSerialize(path);
        }

        private void Form1_FormClosing(object sender, FormClosingEventArgs e)
        {
            WorkWithFille.Serialize(PC_list, path);
        }
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            if (PC_list != null)
            {
                ...
                toolStripStatusLabel1.Text = $"Count PC in Lab:{PC_list.Count} Last action: View Time: {DateTime.Now}";
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            ...
            toolStripStatusLabel1.Text = $"Count PC in Lab:{PC_list.Count} Last action: Search Time: {DateTime.Now}";
        }
        ...
        private void button5_Click(object sender, EventArgs e)
        {
            ...
            toolStripStatusLabel1.Text = $"Count PC in Lab:{PC_list.Count} Last action: Delete Time: {DateTime.Now}";
        }
